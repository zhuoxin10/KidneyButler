...
angular
  .module("kidney.services", ["ionic", "ngResource"])
  ...
  .constant("CONFIG", {
    ...
    // baseUrl: "http://localhost:4060/api/v2/",
    ...
    imgThumbUrl:
      "https://media.haihonghospitalmanagement.com/uploads/photos/resize",
      ...
      return {
        mvMedia: function(type, fileName, ext) {
          return $q(function(resolve, reject) {
            ...
            $cordovaFile
              .moveFile(path, fileName, cordova.file.dataDirectory, newName)
              .then(
                function(success) {
                  // console.log(success);
  ...
  .factory("voice", [
    ...
    "Storage",
    "fs",
    function($filter, $q, $ionicLoading, $cordovaFile, CONFIG, Storage, fs) {
      var audio = {};
      audio.src = "";
      audio.media = {};
        ...
        return $q(function(resolve, reject) {
          ...
          audio.media = new Media(
            ...
            function() {
              ...
              fs.mvMedia("voice", audio.src, ".amr").then(
                function(fileUrl) {
                  console.log(fileUrl);
                  resolve(fileUrl);
                },
      ...
      audio.sendAudio = function(fileUrl, receiver) {
        // return $q(function(resolve, reject) {
        window.JMessage.sendSingleVoiceMessage(
          receiver,
          cordova.file.externalRootDirectory + fileUrl,
          CONFIG.appKey,
          function(response) {
  ...
  .factory("Camera", [
    ...
    "fs",
    "Storage",
    function($q, $cordovaCamera, $cordovaFileTransfer, CONFIG, fs, Storage) {
      return {
        ...
        uploadPicture: function(imgURI, temp_photoaddress) {
          return $q(function(resolve, reject) {
            var uri = encodeURI(
              CONFIG.baseUrl + "upload?token=" + Storage.get("TOKEN")
            );
            ...
            $cordovaFileTransfer.upload(uri, imgURI, options).then(
              function(r) {
  ...
  .factory("Data", [
    ...
    "$interval",
    "CONFIG",
    function($resource, $q, $interval, CONFIG) {
      var serve = {};
      var abort = $q.defer();

      var Service = function() {
        return $resource(
          CONFIG.baseUrl + ":path/:route",
          { path: "services" },
          {
            appointDoc: {
              method: "POST",
              params: { route: "personalDiagnosis" },
              timeout: 100000
            },
            docSchedual: {
              method: "GET",
              params: { route: "availablePD" },
              timeout: 100000
            },
            cancelAppointment: {
              method: "POST",
              params: { route: "cancelMyPD" },
              timeout: 100000
            },
            isMyDoctors: {
              method: "GET",
              params: { route: "relation" },
              timeout: 10000
            }
          }
        );
      ...
      var Order = function() {
        return $resource(
          ...
          { path: "order" },
          {
            ...
            PaidUnfinishedOrders: {
              method: "GET",
              params: { route: "counsel" },
              timeout: 100000
            }
          }
        );
      ...
      var Dict = function() {
        return $resource(
          ...
          { path: "dict" },
          {
            getDiseaseType: {
              method: "GET",
              params: { route: "typeTwo" },
              timeout: 100000
            },
            getDistrict: {
              method: "GET",
              params: { route: "district" },
              timeout: 100000
            },
            getHospital: {
              method: "GET",
              params: { route: "hospital" },
              timeout: 100000
            },
            getHeathLabelInfo: {
              method: "GET",
              params: { route: "typeOne" },
              timeout: 100000
            }
      ...
      var Compliance = function() {
        return $resource(
          ...
          { path: "compliance" },
          {
            getcompliance: {
              method: "GET",
              params: { route: "compliances" },
              timeout: 100000
            },
            postcompliance: {
              method: "POST",
              params: { route: "compliance" },
              timeout: 100000
            }
          }
        );
      ...
      var Counsels = function() {
        return $resource(
          ...
          { path: "counsel" },
          {
            getCounsel: {
              method: "GET",
              params: { route: "counsels" },
              timeout: 100000
            },
            questionaire: {
              method: "POST",
              params: { route: "questionaire" },
              timeout: 100000
            },
            getStatus: {
              method: "GET",
      ...
      var Patient = function() {
        return $resource(
          ...
          { path: "patient" },
          {
            ...
            getMyDoctors: {
              method: "GET",
              params: { route: "myDoctors" },
              timeout: 10000
            },
            getDoctorLists: {
              method: "GET",
              params: { route: "doctors" },
              timeout: 10000
            },
            getCounselRecords: {
              method: "GET",
              params: { route: "counselRecords" },
              timeout: 10000
            },
            ...
            replacePhoto: {
              method: "POST",
              params: {
                route: "wechatPhotoUrl",
                patientId: "@patientId",
                wechatPhotoUrl: "@wechatPhotoUrl"
              },
              timeout: 10000
            },
            ApplyDocInCharge: {
              method: "POST",
              params: { route: "doctorInCharge" },
              timeout: 100000
            },
            FollowDoc: {
              method: "POST",
              params: { route: "favoriteDoctor" },
              timeout: 100000
            },
            UnFollowDoc: {
              method: "POST",
              params: { route: "unfollowFavoriteDoctor" },
              timeout: 100000
            },
            MyDocInCharge: {
              method: "GET",
              params: { route: "myDoctorsInCharge" },
              timeout: 100000
            },
            CancelDocInCharge: {
              method: "POST",
              params: { route: "cancelDoctorInCharge" },
              timeout: 100000
            },
            getFollowDoctors: {
              method: "GET",
              params: { route: "myFavoriteDoctors" },
              timeout: 10000
            }
          }
        );
      ...
      var User = function() {
        return $resource(
          ...
          { path: "alluser" },
          {
            ...
            logOut: {
              method: "POST",
              params: { route: "logout", userId: "@userId" },
              timeout: 100000
            },
            getUserID: {
              method: "GET",
              params: { route: "userID", username: "@username" },
              timeout: 100000
            },
            sendSMS: {
              method: "POST",
              skipAuthorization: true,
              params: { route: "sms", mobile: "@mobile", smsType: "@smsType" },
              timeout: 100000
            }, // 第一次验证码发送成功返回结果为”User doesn't exist“，如果再次发送才返回”验证码成功发送“
            verifySMS: {
              method: "GET",
              skipAuthorization: true,
              params: {
            ...
            getAgree: {
              method: "GET",
              params: { route: "agreement", userId: "@userId" },
              timeout: 100000
            },
            updateAgree: {
              method: "POST",
              skipAuthorization: true,
              params: { route: "agreement" },
              timeout: 100000
            },
      ...
      var Health = function() {
        return $resource(
          ...
          { path: "healthInfo" },
          {
            ...
            getAllHealths: {
              method: "GET",
              params: { route: "healthInfos", userId: "@userId" },
              timeout: 100000
            },
            deleteHealth: {
              method: "POST",
              params: {
                route: "deleteHealthDetail",
                userId: "@userId",
                insertTime: "@insertTime"
              },
              timeout: 100000
      ...
      var Comment = function() {
        return $resource(
          ...
          { path: "comment" },
          {
            ...
            getCommentsByC: {
              method: "GET",
              params: { route: "commentsByCounsel" },
              timeout: 100000
            },
            getCommentsByDoc: {
              method: "GET",
              params: { route: "commentsByDoc" },
              timeout: 100000
            }
          }
        );
      ...
      var Account = function() {
        return $resource(
          ...
          { path: "account" },
          {
            ...
            updateFreeTime: {
              method: "POST",
              params: { route: "freeTime" },
              timeout: 100000
            },
            getCountsRespective: {
              method: "GET",
              params: { route: "countsRespective" },
              timeout: 100000
            }
          }
        );
      ...
      var News = function() {
        return $resource(
          ...
          { path: "new" },
          {
            ...
            getNewsByReadOrNot: {
              method: "GET",
              params: { route: "newsByReadOrNot" },
              timeout: 100000
            },
            setReadOrNot: {
              method: "POST",
              params: { route: "newsStatus" },
              timeout: 100000
            },
            getNotRead: {
              method: "GET",
              params: { route: "allNotReadNews" },
              timeout: 100000
            }
          }
        );
      ...
      var Communication = function() {
        return $resource(
          ...
          { path: "communication" },
          {
            getCommunication: {
              method: "GET",
              params: { route: "communication" },
              timeout: 100000
            },
            newConsultation: {
              method: "POST",
              params: { route: "consultation" },
              timeout: 100000
            }
      ...
      var Mywechat = function() {
        return $resource(
          ...
          { path: "wechat" },
          {
            messageTemplate: {
              method: "POST",
              params: { route: "messageTemplate" },
              timeout: 100000
            },
            // gettokenbycode: {method: 'GET', params: {route: 'gettokenbycode'}, timeout: 100000},
            addOrder: {
              method: "POST",
              params: { route: "addOrder" },
              timeout: 100000
            },
            getUserInfo: {
              method: "GET",
              skipAuthorization: true,
              params: { route: "getUserInfo" },
              timeout: 100000
            }
          }
        );
      ...
      var Devicedata = function() {
        return $resource(
          ...
          { path: "devicedata" },
          {
            ...
            BPDeviceBinding: {
              method: "POST",
              params: { route: "BPDevice", op: "binding" },
              timeout: 10000
            },
            BPDeviceDeBinding: {
              method: "POST",
              params: { route: "BPDevice", op: "debinding" },
              timeout: 10000
            },
            urineConnect: {
              method: "GET",
              url: CONFIG.urineConnectUrl + ":path/:route/:op",
              params: { route: "niaodaifu", op: "loginparam" },
              timeout: 10000
            }
          }
        );
      ...
      var Forum = function() {
        return $resource(
          ...
          { path: "forump" },
          {
            allposts: {
              method: "GET",
              params: { route: "allposts" },
              timeout: 10000
            },
            myposts: {
              method: "GET",
              params: { route: "myposts" },
              timeout: 10000
            },
            mycollection: {
              method: "GET",
              params: { route: "mycollection" },
              timeout: 10000
            },
            newpost: {
              method: "POST",
              params: { route: "posting" },
              timeout: 100000
            },
            favorite: {
              method: "POST",
              params: { route: "favorite" },
              timeout: 100000
            },
            deletefavorite: {
              method: "POST",
              params: { route: "deletefavorite" },
              timeout: 100000
            },
            deletepost: {
              method: "POST",
              params: { route: "deletepost" },
              timeout: 100000
            },
            postcontent: {
              method: "GET",
              params: { route: "postcontent" },
              timeout: 100000
            },
            deletecomment: {
              method: "POST",
              params: { route: "deletecomment" },
              timeout: 100000
            },
            comment: {
              method: "POST",
              params: { route: "comment" },
              timeout: 100000
            },
            reply: {
              method: "POST",
  ...
  .factory("version", [
    ...
    "$cordovaAppVersion",
    "$ionicPopup",
    function($q, Data, $cordovaAppVersion, $ionicPopup) {
      var self = this;
              ...
              if (angular.isArray(data.results.msg)) {
                ...
                for (x in data.results.msg) {
                  json.template +=
                    ...
                    "V" +
                    data.results.msg[x].versionName +
                    " 更新: " +
                    data.results.msg[x].content +
                    "</p>";
                }
                if (
                  Number(data.results.msg[0].versionName.split(".")[0]) >
                          ...
                          if (window.cordova && window.cordova.InAppBrowser) {
                            if (ionic.Platform.isIOS()) {
                              window.cordova.InAppBrowser.open(
                                "https://itunes.apple.com/cn/app/%E8%82%BE%E4%BA%8B%E7%AE%A1%E5%AE%B6/id1274887634?mt=8",
                                "_system"
                              );
                            } else if (ionic.Platform.isAndroid()) {
                              window.cordova.InAppBrowser.open(
                                "https://media.haihonghospitalmanagement.com/download",
                                "_system"
                              );
                              // 安卓下载地址
                            }
  ...
  .factory("otherTask", [
    ...
    "Compliance",
    "Storage",
    function(Task, Compliance, Storage) {
      ...
      var HemoTaskDone = function(task, flag) {
        ...
        if (instructionArry.length > EndArry.length) {
          // 判断是添加还是修改，修改不加次数
          var newEnd = dateNowStr;
          EndArry.push(newEnd);
          task.Progress =
            (Math.round((EndArry.length / task.times) * 10000) / 100).toFixed(
              2
            ) + "%"; // 更新进度条
        }
      ...
      var OtherTaskDone = function(task, Description) {
        ...
        if (task.endTime != "2050-11-02T07:58:51.718Z") {
          // 说明任务已经执行过
          task.DoneFlag = true;
        } else {
          task.DoneFlag = false;
        }
        NextTime = ChangeTimeForm(
          SetNextTime(
            task.startTime,
            task.frequencyTimes,
            task.frequencyUnits,
      ...
      // 插入任务执行情况
      this.Postcompliance_UpdateTaskStatus = function(
        task,
        otherTasks,
        healthID
      ) {
  ...
  .factory("DoctorService", [
    ...
    "$state",
    "$ionicLoading",
    function($q, Patient, Storage, $ionicPopup, $state, $ionicLoading) {
      var self = this;
      /**
          ...
          function(data) {
            ...
            if (data.message === "已申请主管医生，请等待审核!") {
              $ionicPopup.alert({
                title: "请等待审核",
                template:
                  "您已经申请了主管医生，在审核期间请耐心等待！在申请未被处理期间没有权限再次申请主管医生，敬请谅解！"
              });
            } else if (data.message === "当前已有主管医生!") {
              $ionicPopup.confirm({
                title: "删除主管医生",
                template:
                  "您当前已有主管医生，是否需要删除当前的主管医生？后果将造成其剩余服务时间作废且款项不会返还，点击确认后将删除当前主管医生并进入申请其他医生页面。请谨慎！",
                buttons: [
                  { text: "取消" },
                  {
                    text: "确认",
      ...
      self.LikeDoctor = function(Doctor) {
         ...
         * @return   data:Object
         */
        Patient.FollowDoc({ doctorId: Doctor.userId }).then(
          function(data) {
      ...
      self.DislikeDoctor = function(Doctor) {
         ...
         * @return   data:Object
         */
        Patient.UnFollowDoc({ doctorId: Doctor.userId }).then(
          function(data) {
      ...
      self.DeleteMyDoc = function() {
        ...
        $ionicPopup.confirm({
          title: "删除主管医生",
          template:
            "您当前已有主管医生，是否需要删除当前的主管医生？后果将造成其剩余服务时间作废且款项不会返还，是否继续？",
          buttons: [
            {
              text: "取消",
              onTap: function(e) {
            ...
            },
            {
              ...
              onTap: function(e) {
                 ...
                 * @return   data:Object
                 */
                Patient.CancelDocInCharge().then(
                  function(data) {
                    deferred.resolve(data);
                  },
                  function(err) {
  ...
  .factory("socket", [
    ...
    "socketFactory",
    "CONFIG",
    function($rootScope, socketFactory, CONFIG) {
  ...
  .factory("notify", [
    ...
    "CONFIG",
    "arrTool",
    function($cordovaLocalNotification, $cordovaFileTransfer, CONFIG, arrTool) {
      var notices = {},
      ...
      function noteGen(msg) {
        ...
        if (type == "text") {
          ...
          if (subT == "card") {
            ...
            if (
              msg.content.counsel.type == "2" ||
              msg.content.counsel.type == "3"
            )
              tag1 = "[新问诊]";
            if (
              msg.content.counsel.type == "6" ||
              msg.content.counsel.type == "7"
            )
              tag1 = "[新加急咨询]";
            ...
            if (msg.content.counseltype == 2 || msg.content.counseltype == 3)
              tag2 = "[问诊结束]";
            if (msg.content.counseltype == 6 || msg.content.counseltype == 7)
              tag2 = "[加急咨询结束]";
            note += tag2;
          } else {
            note += "[新消息]";
      ...
      return {
        add: function(msg) {
          if (
            ...
            (msg.content.type == "counsel-upgrade" ||
              msg.content.type == "count-notice")
          )
            return;
  ...
  .factory("session", [
    ...
    "mySocket",
    "$ionicHistory",
    function(Storage, socket, mySocket, $ionicHistory) {
      return {
        logOut: function() {
          Storage.rm("TOKEN");
    ...
    function(
      ...
      var whichTemplate = {
        "1": {
          counselType: 1,
          counselTemplate:
            "您上次的咨询尚未新建成功，点击确认继续填写完善上次的咨询问卷，进入咨询后，根据您提供的问题及描述，医生最多做三次回答，答满三次后，本次咨询结束，请尽量详细描述病情和需求；如不满三个问题，24小时后本次咨询关闭。医生会在24小时内回答，如超过24小时医生未作答，本次咨询关闭，且不收取费用。"
        },
        "2": {
          counselType: 2,
          counselTemplate:
            "您上次的问诊尚未新建成功，点击确认继续填写完善上次的咨询问卷，进入问诊后，您询问该医生的次数不限，最后由医生结束此次问诊，请尽量详细描述病情和需求。医生会在24小时内回答，如超过24小时医生未作答，本次咨询关闭，且不收取费用。"
        },
        "3": {
          counselType: 3,
          counselTemplate:
        ...
        "6": {
          counselType: 6,
          counselTemplate:
            "您上次的加急咨询尚未新建成功，点击确认继续填写完善上次的咨询问卷，进入加急咨询后，根据您提供的问题及描述，医生最多做三次回答，答满三次后，本次咨询结束，请尽量详细描述病情和需求；如不满三个问题，2小时后本次咨询关闭。医生会在2小时内回答，如超过2小时医生未作答，本次咨询关闭，且不收取费用。"
        },
        "7": {
          counselType: 7,
          counselTemplate:
        ...
        Counsels.getStatus({
          ...
          function(data) {
            ...
            if (data.result != "请填写咨询问卷!" && data.result.status == 1) {
               ...
               * @return   {[type]}
               */
              Order.PaidUnfinishedOrders({ doctorId: DoctorId }).then(function(
                data
              ) {
                // debugger
                  ...
                  if (data.msg != "nonexistence") {
                    ...
                    $ionicPopup
                      .confirm({
                        title: "咨询确认",
                        template:
                          whichTemplate[data.results[0].type].counselTemplate,
                        okText: "确认",
                        cancelText: "取消"
                      })
                      .then(function(res) {
                        if (res) {
                          ...
                          $state.go("tab.consultQuestionnaire", {
                            DoctorId: DoctorId,
                            counselType:
                              whichTemplate[data.results[0].type].counselType
                          });
                        }
                        self.consultable = 1;
                      });
                    ...
                    Patient.MyDocInCharge().then(
                      function(DocInCharge) {
                        // 主管医生不限次数
                        if (
                          DocInCharge.message == "当前已有主管医生!" &&
                          DocInCharge.results.doctorId.userId === DoctorId
                        ) {
                          self.consultable = 0;
                          $ionicPopup
                            .confirm({
                              // 没有免费也没有回答次数 交钱 充值 加次数
                              title: "咨询确认",
                              template:
                                "进入咨询后，根据您提供的问题及描述，医生最多做三次回答，答满三次后，本次咨询结束，请尽量详细描述病情和需求；如不满三个问题，24小时后本次咨询关闭。医生会在24小时内回答，如超过24小时医生未作答，本次咨询关闭，且不收取费用。是否确认付费？",
                              okText: "确认",
                              cancelText: "取消"
                            })
                            .then(function(res) {
                              ...
                              if (res) {
                                 ...
                                 */
                                Mywechat.addOrder(neworder).then(
                                  function(orderdata) {
                                    if (orderdata.results.status === 1) {
                                      ...
                                      var params = {
                                        ...
                                        prepayid:
                                          orderdata.results.prepay_id[0], // prepay id
                            ...
                            if (succ.result.freeTimes > 0) {
                              ...
                              $ionicPopup
                                .confirm({
                                  title: "咨询确认",
                                  template:
                                    "您还有剩余免费咨询次数，进入咨询后，根据您提供的问题及描述，医生最多做三次回答，答满三次后，本次咨询结束，请尽量详细描述病情和需求；如不满三个问题，24小时后本次咨询关闭。医生会在24小时内回答，如超过24小时医生未作答，本次咨询关闭，且不耗费免费咨询次数。点击确认进入免费咨询。",
                                  okText: "确认",
                                  cancelText: "取消"
                                })
                                .then(function(res) {
                                        ...
                                        if (orderdata.results.status === 1) {
                                          ...
                                          var params = {
                                            ...
                                            prepayid:
                                              orderdata.results.prepay_id[0], // prepay id
                                            noncestr:
                                              orderdata.results.nonceStr, // nonce
                                            timestamp:
                                              orderdata.results.timestamp, // timestamp
                                            sign: orderdata.results.paySign // signed string
                                          };
                                          // alert(JSON.stringify(params));
                                          /**
          ...
          function(data) {
            ...
            if (self.consultable == 1) {
              ...
              if (data.result != "请填写咨询问卷!" && data.result.status == 1) {
                ...
                if (data.result.type == 1) {
                  ...
                  $ionicPopup
                    .confirm({
                      title: "问诊确认",
                      template:
                        "您有尚未结束的咨询，补齐差价可升级为问诊，问诊将在升级后24小时自动结束或者由医生结束，问诊中询问医生的次数不限。确认付费升级为问诊？",
                      okText: "确认",
                      cancelText: "取消"
                    })
                    .then(function(res) {
                 ...
                 * @return   {[type]}
                 */
                Order.PaidUnfinishedOrders({ doctorId: DoctorId }).then(
                  function(succ) {
                    if (succ.msg != "nonexistence") {
                      $ionicPopup
                        .confirm({
                          title: "咨询确认",
                          template:
                            whichTemplate[succ.results[0].type].counselTemplate,
                          okText: "确认",
                          cancelText: "取消"
                        })
                        .then(function(res) {
                          if (res) {
                            ...
                            $state.go("tab.consultQuestionnaire", {
                              DoctorId: DoctorId,
                              counselType:
                                whichTemplate[succ.results[0].type].counselType
                            });
                          }
                          self.consultable = 1;
                        });
                      ...
                      $ionicPopup
                        .confirm({
                          ...
                          title: "咨询确认",
                          template:
                            "进入问诊后，您询问该医生的次数不限，最后由医生结束此次问诊，请尽量详细描述病情和需求。医生会在24小时内回答，如超过24小时医生未作答，本次咨询关闭，且不收取费用。是否确认付费?",
                          okText: "确认",
                          cancelText: "取消"
                        })
                        .then(function(res) {
                ...
                if (data.result.type == 1) {
                  ...
                  $ionicPopup
                    .confirm({
                      title: "问诊确认",
                      template:
                        "您有尚未结束的咨询，补齐差价可升级为加急咨询，升级为加急咨询后医生会在2小时内回答，医生的剩余回答次数与未升级为加急咨询前一致，如超过2小时医生未作答，本次咨询关闭，且不收取费用。确认付费升级为加急咨询？",
                      okText: "确认",
                      cancelText: "取消"
                    })
                    .then(function(res) {
                    ...
                    if (succ.msg != "nonexistence") {
                      ...
                      $ionicPopup
                        .confirm({
                          ...
                          title: "咨询确认",
                          template:
                            "选择加急咨询，医生会在2小时内回答，如超过2小时医生未作答，本次加急咨询关闭，且不收取费用。根据您提供的问题及描述，医生最多做三次回答，答满三次后，本次加急咨询结束，请尽量详细描述病情和需求；如不满三个问题，2小时后本次加急咨询关闭。是否确认付费？",
                          okText: "确认",
                          cancelText: "取消"
                        })
                        .then(function(res) {
  ...
  .factory("Authentication", [
    ...
    "Storage",
    "$q",
    function(jwtHelper, CONFIG, Storage, $q) {
      var self = this;
      this.check = function() {
